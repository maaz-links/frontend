  ...
  return (
    <>
      ...
      <div className="relative w-full h-screen overflow-hidden">
        ...
        <div className="absolute bg-white left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-[526px] my-[100px]  rounded-[30px] shadow-[0px_28px_34.7px_rgba(0,0,0,0.05)] px-[40px] py-[40px]">
