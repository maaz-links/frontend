...
<h3 className="text-[32px] md:pt-[70px]">Sign Up </h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 mt-[58px]  gap-x-[55px] w-full max-w-[865px]">
        ...
        <div className="mt-[20px] md:mt-[58px] mb-[0px]">
          <label className="block mb-[13px]">I am:</label>
          <label className="block space-x-2">
            <input type="radio" name="role" value="Hostess" checked={formData.role === "Hostess"} onChange={handleChange} />
            <span>Hostess</span>
          </label>
          <label className="block  space-x-2">
            <input type="radio" name="role" value="Model" checked={formData.role === "Model"} onChange={handleChange} />
            <span>Model</span>
          </label>
        </div>
