        ...
        <div>
          <div className="mt-[35px] px-[15px]">
            ...
            <p className="text-center text-[14px] font-[400] mt-[18px]">
              Each role is customizable to the needs and comfort of both parties.<br/>You're always in control.
            </p>
            
            <div className="max-w-sm md:max-w-[1500px] m-auto mt-[36px]">
              {/* Slider Container */}
              <div className="slider-container">
                <Slider ref={sliderRef} {...settings}>
                  {shownServices.map((service, index) => (
                    <div className="item cursor-pointer px-2" key={index}>
              ...
              {/* Custom Arrows Container - positioned below the slider */}
              <div className="flex justify-center items-center mt-6">
                <button 
                  onClick={() => sliderRef.current?.slickPrev()}
                  className="mx-2 p-2 rounded-full hover:bg-gray-100 transition-colors text-black"
                >
                  <svg width="51" height="16" viewBox="0 0 51 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M0.411243 7.29289C0.0207214 7.68342 0.0207214 8.31658 0.411243 8.70711L6.7752 15.0711C7.16573 15.4616 7.79889 15.4616 8.18942 15.0711C8.57994 14.6805 8.57994 14.0474 8.18942 13.6569L2.53257 8L8.18942 2.34315C8.57994 1.95262 8.57994 1.31946 8.18942 0.928932C7.79889 0.538408 7.16573 0.538408 6.7752 0.928932L0.411243 7.29289ZM50.1508 7L1.11835 7V9L50.1508 9V7Z" fill="currentColor" />
                  </svg>
