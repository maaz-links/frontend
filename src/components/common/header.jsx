...
function Header() {
  ...
  const {token,user} = useStateContext();
    return (
      <>
       <div>
        <div className="header bg-[#595959] md:h-[115px] p-[15px] flex flex-col md:flex-row items-center justify-between
">
<div className="logo">
<Link to="/">
<img src={Logo} />
