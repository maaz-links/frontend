  ...
  return (
    ...
    {shownServices.length != 0  && <div>
      <div className="mt-[35px] px-[15px]">
        ...
        <p className="text-center text-[14px] font-[400] mt-[18px]">Each role is customizable to the needs and comfort of both parties.<br/>You’re always in control.</p>
        {false && <div className="slider-container max-w-sm md:max-w-[1120px] m-auto mt-[36px]">
          <Slider {...settings}>
    ...
    <div className="mt-[35px] px-[15px] max-w-[1300px] m-auto">
        ...
        {[1,2,3].map((service, index) => (
              <div className="item cursor-pointer w-full md:w-1/3 my-4 md:my-0" key={index}>
                {/* <a href="#" > */}
                <div className="item-inner rounded-4xl overflow-hidden relative h-100">
                  {/* <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-t from-black/90 via-30% via-transparent to-transparent z-10"></div> */}
                  <img src='/src/assets/images/servic1.png' className={`w-full h-full object-cover`} />
                  {/* <div className='innertext w-full'>

                  <h3 className="text-[#fff] text-[24px] z-20 absolute bottom-2 left-2">Wing Woman</h3>
                  <p>asdasdas</p>
                  </div> */}
                  <div className="absolute bottom-5 left-0 mx-4 z-20 text-black">

                  <h3 className="text-[24px] font-semibold z-20">Wing Woman</h3>
                  <p>
