...
<a href='#' className='btn bg-[#D9D9D9]  p-[10px] w-full text-[20px] font-[400] leading-[130%]'>Search</a>
<a href='#' className='btn bg-[#D9D9D9] block p-[10px] w-full text-[20px] font-[400] leading-[130%]'>Sign Up </a>
</div>
</div>
